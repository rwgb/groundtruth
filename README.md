...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/self--checks-396%20%C2%B7%20red--team%2014%2F14-111111?style=flat-square" alt="396 self-checks, red-team 14/14">
...
- **Dogfood result:** running Groundtruth's audit on its own source, self-match false positives in the engine went to **0** (`Class 2`) and phantom-import FPs **3 → 0** (`Class 4`); self-checks **242 → 396**, red-team **14/14**.
...
```bash
node hooks/groundtruth.test.mjs   # 396 assert-based unit checks, no deps
